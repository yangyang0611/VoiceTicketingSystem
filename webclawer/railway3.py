...
# function webclawer(user_endStationCity, user_endStation, user_startTime, user_car):
...
user_startStationCity = '臺南市'
input_startStationCity = user_startStationCity
time.sleep(3)
...
# 點選縣市
driver.find_element_by_xpath(
    "//*[@id='mainline']/div[1]/ul/li[15]/button").click()
...
user_startStation = '臺南市'
input_startStation = user_startStation
time.sleep(1)

# 點選出發站
driver.find_element_by_xpath(
    "//*[@id='city67000']/ul/li[12]/button").click()
# 出發站一系列動作--結束
# -----------============================================================================================ #
...
input_endStation = user_endStation
time.sleep(1)
...
input_startTime = user_startTime
driver.execute_script(
    "document.getElementById('startTime').value='{0}'".format(user_startTime))
...
if doc("#errorDiv").attr('style') == "display: none" and errorMessage == "":
    ...
    if alertMessage != '':
        ...
        # find_car(dep_station, arr_station, date, dep_time, arr_time)
