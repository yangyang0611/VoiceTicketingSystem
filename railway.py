...
if doc("#errorDiv").attr('style') == "display: none" and errorMessage == "":
    ...
    for station in doc("#{0} > ul > li:nth-child(n+1) > button".format(cities_startStation[input_endStationCity])).items():
        ...
        # driver.find_element_by_xpath("//*[@id='pageContent']/div/table/tbody/tr[{0}]/td[10]/form/button".format()
        driver.find_element_by_xpath(
            "//*[@id='pageContent']/div/table/tbody/tr[2]/td[10]/form/button").click()
        # //*[@id="pageContent"]/div/table/tbody/tr[2]/td[10]/form/button
